...
Процедура ОбработкаКомандыПоляКомментария(Форма, Команда) Экспорт
	...
	ИначеЕсли СтрНайти(Команда.Имя, "РМ_КомандаMDПрограммныйКод") = 1 Тогда
		...
		ТекстЗамены= "РМ_КомандаMDПрограммныйКод_";
	...
	ИначеЕсли СтрНайти(Команда.Имя, "РМ_КомандаMDТаблица") = 1 Тогда
		...
		ТекстЗамены= "РМ_КомандаMDТаблица_";

	ИначеЕсли СтрНайти(Команда.Имя, "РМ_КомандаMDВставитьИзображениеИзБуфераОбмена") = 1 Тогда
		ТекстЗамены= "РМ_КомандаMDВставитьИзображениеИзБуфераОбмена_";

		ПутьКДаннымБезЛишнего=СтрЗаменить(Команда.Имя, ТекстЗамены, "");
#Если Не ВебКлиент Тогда
		ДвоичныеДанныеФайла=РМ_БуферОбменаКлиент.КартинкаИзБуфера("ДвоичныеДанные");
...
#КонецЕсли
	ИначеЕсли
	СтрНайти(Команда.Имя, "РМ_КомандаMDДобавитьФайл") = 1 Тогда
	...
	ИмяЭлементаФормы=РМ_MarkdownКлиентСервер.ПрефиксЭлементовФормы() + Сред(Команда.Имя, СтрДлина(ТекстЗамены) + 1);
