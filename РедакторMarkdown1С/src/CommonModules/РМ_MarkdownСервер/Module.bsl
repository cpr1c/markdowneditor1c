...
Процедура ВставитьПолеРедактированияТекстаНаФорму(Форма, ГруппаЭлементовТекста, ПутьКДанным,
	ВариантПодсветкиСинтаксиса = "vs") Экспорт
...
Процедура ДобавитьКнопкиВКоманднуюПанельРедактированияПоляMarkdown(Форма, ГруппаПоляРедактирования,
	...
	//ИЗменения шрифта
	ДобавитьКомандуНаКоманднуюПанельРедактированияMarkdown("КомандаMDЖирный", "Жирный", БиблиотекаКартинок.РМ_MDЖирный,
		Форма, КоманднаяПанель, ПутьКДаннымРедактирования);
	ДобавитьКомандуНаКоманднуюПанельРедактированияMarkdown("КомандаMDКурсив", "Курсив", БиблиотекаКартинок.РМ_MDКурсив,
		Форма, КоманднаяПанель, ПутьКДаннымРедактирования);
	ДобавитьКомандуНаКоманднуюПанельРедактированияMarkdown("КомандаMDЗачеркнутый", "Зачеркнутый",
		БиблиотекаКартинок.РМ_MDЗачеркнутый, Форма, КоманднаяПанель, ПутьКДаннымРедактирования);	
	...
	//Всякое
	ДобавитьКомандуНаКоманднуюПанельРедактированияMarkdown("КомандаMDЦитата", "Цитата", БиблиотекаКартинок.РМ_MDЦитата,
		Форма, КоманднаяПанель, ПутьКДаннымРедактирования);
	...
	ДобавитьКомандуНаКоманднуюПанельРедактированияMarkdown("КомандаMDМаркерыСписок", "Маркированный список",
		БиблиотекаКартинок.РМ_MDМаркерыСписок, Форма, КоманднаяПанель, ПутьКДаннымРедактирования);
	ДобавитьКомандуНаКоманднуюПанельРедактированияMarkdown("КомандаMDНумерованныйСписок", "Нумерованный список",
		БиблиотекаКартинок.РМ_MDНумерованныйСписок, Форма, КоманднаяПанель, ПутьКДаннымРедактирования);
	...
	Если Не ЭтоВебКлиент Тогда
		...
		ДобавитьКомандуНаКоманднуюПанельРедактированияMarkdown("КомандаMDВставитьИзображениеИзБуфераОбмена",
			"Изображение из буфера", БиблиотекаКартинок.РМ_MDВставитьКартинкуИзБуфера, Форма, КоманднаяПанель,
	...
	// подменю для вставки
	ОписаниеЭлемента=НовыйОписаниеРеквизитаЭлемента();
	ОписаниеЭлемента.Имя="ПодменюВставитьЗагруженноеИзображение" + "_" + ПутьКДаннымРедактирования;
...
Функция ВывестиЭлементыПрисоединенногоФайлаНаФорму(Форма, ИмяФайла, ИдентификаторСтроки, ПутьКДаннымБезЛишнего) Экспорт

	Элементы = Форма.Элементы;

	ИмяТаблицыПрисоединенныхФайлов=РМ_MarkdownКлиентСервер.ИмяТаблицыПрисоединенныхФайлов(ПутьКДаннымБезЛишнего);

	ИндексСтроки = Форма[ИмяТаблицыПрисоединенныхФайлов].Индекс(
		Форма[ИмяТаблицыПрисоединенныхФайлов].НайтиПоИдентификатору(ИдентификаторСтроки));
...
//	Эскиз.Высота = 4;
	...
	Команда.Действие   = "Подключаемый_УдалитьНовыйПрисоединенныйФайл";
	...
	Команда.Действие   = "Подключаемый_ОткрытьНовыйПрисоединенныйФайл";
	...
	Команда.Действие   = "Подключаемый_ОбработкаКомандыПоляКомментария";
	Команда.Отображение = ОтображениеКнопки.Текст;

	Подменю = Элементы.Найти("ПодменюВставитьЗагруженноеИзображение_" + ПутьКДаннымБезЛишнего);
