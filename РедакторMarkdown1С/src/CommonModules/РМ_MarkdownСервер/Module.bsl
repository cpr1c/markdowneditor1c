...
Процедура ДобавитьКнопкиВКоманднуюПанельРедактированияПоляMarkdown(Форма,ГруппаПоляРедактирования,ПутьКДаннымРедактирования) 
	...
	ДобавитьКомандуНаКоманднуюПанельРедактированияMarkdown("КомандаMDДобавитьЗаголовки","Заголовок 1",БиблиотекаКартинок.РМ_ЗаголовокH1,Форма,КоманднаяПанель,ПутьКДаннымРедактирования);	
