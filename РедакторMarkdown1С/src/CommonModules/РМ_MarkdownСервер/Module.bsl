...
Процедура ДобавитьКнопкиВКоманднуюПанельРедактированияПоляMarkdown(Форма,ГруппаПоляРедактирования,ПутьКДаннымРедактирования) 
	...
	ДобавитьКомандуНаКоманднуюПанельРедактированияMarkdown("КомандаMDДобавитьЗаголовки","Заголовок 1",БиблиотекаКартинок.РМ_MDДобавитьЗаголовки,Форма,КоманднаяПанель,ПутьКДаннымРедактирования);	
