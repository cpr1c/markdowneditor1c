...
Функция ИмяТаблицыПрисоединенныхФайлов(ПутьКДаннымБезЛишнего) Экспорт
	Возврат "ТаблицаПрисоединенныхФайлов_"+ПутьКДаннымБезЛишнего;
КонецФункции

Функция ИмяГруппыНовыхПрисоединенныхФайлов(ПутьКДаннымБезЛишнего) Экспорт
	Возврат "НовыеПрисоединенныеФайлы"+ПутьКДаннымБезЛишнего;
КонецФункции
...
Функция ИмяГруппыНовогоПрисоединеногоФайла(ПутьКДаннымБезЛишнего, ИдентификаторСтроки) Экспорт
	Возврат "Группа_"+ИмяЭлементаНадписиНовогоПрисоединеногоФайла(ПутьКДаннымБезЛишнего, ИдентификаторСтроки);
КонецФункции

Функция ИмяГруппыКомандНовогоПрисоединеногоФайла(ПутьКДаннымБезЛишнего, ИдентификаторСтроки) Экспорт
	Возврат "ГруппаКоманд_"+ИмяЭлементаНадписиНовогоПрисоединеногоФайла(ПутьКДаннымБезЛишнего, ИдентификаторСтроки);
КонецФункции

Функция ИмяКомандыУдалитьНовогоПрисоединеногоФайла(ПутьКДаннымБезЛишнего, ИдентификаторСтроки) Экспорт
	Возврат "Удалить"+ИмяЭлементаНадписиНовогоПрисоединеногоФайла(ПутьКДаннымБезЛишнего, ИдентификаторСтроки);
КонецФункции

Функция ИмяКомандыОткрытьНовогоПрисоединеногоФайла(ПутьКДаннымБезЛишнего, ИдентификаторСтроки) Экспорт
	Возврат "Открыть"+ИмяЭлементаНадписиНовогоПрисоединеногоФайла(ПутьКДаннымБезЛишнего, ИдентификаторСтроки);
КонецФункции

Функция ИмяКомандыВставитьНовогоПрисоединеногоФайла(ПутьКДаннымБезЛишнего, ИдентификаторСтроки) Экспорт
	Возврат "Вставить"+ИмяЭлементаНадписиНовогоПрисоединеногоФайла(ПутьКДаннымБезЛишнего, ИдентификаторСтроки);
КонецФункции
...
Функция ДанныеПрисовединенныхФайлов(Форма,ПутьКДаннымБезЛишнего) Экспорт
